...
function child (bindings, options) {
  ...
  if (options.hasOwnProperty('customLevels') === true) {
    ...
    instance[customLevelsSym] = Object.assign({}, this[customLevelsSym], options.customLevels)
    instance.levels = mappings(instance[customLevelsSym], instance[useOnlyCustomLevelsSym])
    genLsCache(instance)
  }
